...
require('lazy').setup({
  ...
  -- "<leader>/" to comment normal / visual regions / lines
  -- mappings are set up below
...
vim.keymap.set('n', '<leader>fc', require('telescope.builtin').grep_string, { desc = '[F]ind Word Under [C]ursor' })
vim.keymap.set('n', '<leader>fw', require('telescope.builtin').live_grep, { desc = '[F]ind [W]ords by Grep' })
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'graphql', 'scss' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ks', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Wor[k]space [S]ymbols')
  ...
  nmap('<leader>ka', vim.lsp.buf.add_workspace_folder, 'Wor[k]space [A]dd Folder')
  nmap('<leader>kr', vim.lsp.buf.remove_workspace_folder, 'Wor[k]space [R]emove Folder')
  nmap('<leader>kl', function()
    print(vim.inspect(vim.lsp.buf.list_workspace_folders()))
  end, 'Wor[k]space [L]ist Folders')
